...
// Marshal-deprecation slice C2: the MarshalSink/MarshalSource bridge
// layer (adapters + proxy factories) is deleted — nothing bridges
// through Marshal anymore.
...
// survives below only as a raw byte buffer with no remaining in-tree
// users — deletion of the class itself is the final endgame step.
