...
CLIENT_INCUMBENT_ORACLE = frozenset(
    {
        ...
        ('T', 'srpc::Client@srpc.client::add_on_error(rusty::Function<void (srpc::RpcError@srpc.errors, rusty::String const&) const>) const'),
        ...
        ('T', 'srpc::ClientConnection@srpc.client::invoke_error_callback(int, rusty::String const&) const'),
        ...
        ('T', 'srpc::ClientPool@srpc.client::close_idle_clients(rusty::String const&, unsigned long) const'),
        ('T', 'srpc::ClientPool@srpc.client::get_client(rusty::String const&) const'),
        ('T', 'srpc::ClientPool@srpc.client::get_healthy_client_count(rusty::String const&) const'),
        ...
        ('T', 'srpc::ClientPool@srpc.client::remove_unhealthy_clients(rusty::String const&) const'),
        ...
        ('T', 'srpc::clientpool_close_idle_clients@srpc.client(srpc::ClientPool@srpc.client const&, rusty::String const&, unsigned long)'),
        ('T', 'srpc::clientpool_connect_client@srpc.client(rusty::Arc<srpc::Client@srpc.client> const&, rusty::String const&)'),
        ('T', 'srpc::clientpool_get_client@srpc.client(srpc::ClientPool@srpc.client const&, rusty::String const&)'),
        ('T', 'srpc::clientpool_get_healthy_client_count@srpc.client(srpc::ClientPool@srpc.client const&, rusty::String const&)'),
        ...
        ('T', 'srpc::clientpool_remove_unhealthy_clients@srpc.client(srpc::ClientPool@srpc.client const&, rusty::String const&)'),
...
ABI_SPECS = {
        ...
        surface=frozenset(
            {
                ...
                "void invoke_on_error(LegacyRpcError error, const rusty::String& message) const;",
        ...
        symbols=frozenset(
            {
                ...
                ('T', 'srpc::CallbackManager@srpc.callbacks::add_on_error(rusty::Function<void (srpc::RpcError@srpc.errors, rusty::String const&) const>) const'),
                ...
                ('T', 'srpc::CallbackManager@srpc.callbacks::invoke_on_error(srpc::RpcError@srpc.errors, rusty::String const&) const'),
                ...
                ('T', 'srpc::invoke_error_callback_safely@srpc.callbacks(rusty::Arc<rusty::Function<void (srpc::RpcError@srpc.errors, rusty::String const&) const>> const&, srpc::RpcError@srpc.errors, rusty::String const&)'),
            }
        ),
    ),
        ...
        symbols=frozenset(
            {
                ...
                ('T', 'srpc::InMemorySwitchboard@srpc.inmemory_channel::find_listener(rusty::String const&) const'),
                ...
                ('T', 'srpc::InMemorySwitchboard@srpc.inmemory_channel::unregister_listener(rusty::String const&) const'),
    ...
    "srpc.any_message": AbiSpec(
        surface=frozenset(
            {
                'bool is_a() const;',
                'export bool is_registered_name(const rusty::String& name);',
                ...
                'export rusty::Option<::srpc::SerializableProxy> create(const rusty::String& name);',
        ...
        symbols=frozenset(
            {
                ...
                ('T', 'srpc::any_message_registry::create@srpc.any_message(rusty::String const&)'),
                ('T', 'srpc::any_message_registry::is_registered_name@srpc.any_message(rusty::String const&)'),
    ...
    "srpc.server": AbiSpec(
        ...
        symbols=frozenset({
            ...
            ('T', 'srpc::server_parse_port@srpc.server(rusty::String const&)'),
